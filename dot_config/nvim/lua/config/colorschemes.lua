...
-- local colorscheme = get_if_available('kanagawa-paper-ink')
-- local colorscheme = get_if_available('kanagawa-paper-canvas')
...
-- local colorscheme = get_if_available('tokyonight-day')
